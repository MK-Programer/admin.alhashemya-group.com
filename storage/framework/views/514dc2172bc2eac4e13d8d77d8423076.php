<?php $__env->startSection('title'); ?>
    <?php echo app('translator')->get('translation.about_us'); ?>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <div class="mt-0 mb-3">
                        <a href="<?php echo e(route('showCreateAboutUs')); ?>" id="create_about_us" class="btn btn-primary"><?php echo app('translator')->get('translation.create_new_about_us'); ?></a>
                    </div>
                    <table id="about_us_table" class="table table-striped dt-responsive nowrap w-100">
                        <thead>
                            <tr>
...
<?php $__env->startSection('script'); ?>
    ...
    <script src="<?php echo e(asset('build/js/about-us/all-about-us.js')); ?>"></script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/dpe4njh3p6hj/public_html/alhashemya-group/admin/resources/views/about-us/all-about-us.blade.php ENDPATH**/ ?>