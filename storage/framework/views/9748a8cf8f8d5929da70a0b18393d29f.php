...
<form method="post" enctype="multipart/form-data" action="<?php echo e(route('saveUpdatedProduct')); ?>" id="update_product">
    <?php echo csrf_field(); ?>
    <input type="hidden" id="product_id" name="product_id" value="<?php echo e($productId); ?>">
                    ...
                    <?php if($item->type == 'application'): ?>
                        ...
                        <div data-repeater-item class="row">
                            <div class="mb-3 col-lg-10">
                                <input type="text" name="old_application_<?php echo e($key); ?>" value="<?php echo e($item->info); ?>" placeholder="<?php echo app('translator')->get('translation.enter_application'); ?>" class="form-control" />
                            </div>
                            <div class="col-lg-2">
                                <div class="d-grid">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/dpe4njh3p6hj/public_html/alhashemya-group/admin/resources/views/products/update-product.blade.php ENDPATH**/ ?>