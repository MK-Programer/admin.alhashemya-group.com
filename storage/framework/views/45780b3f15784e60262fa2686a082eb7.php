        ...
        <div class="card">
            <div class="card-body">
                <form class="form-horizontal" enctype="multipart/form-data" id="update_company">
                    <?php echo csrf_field(); ?>
                    <input type="hidden" id="company_id" name="company_id" value="<?php echo e($companyId); ?>">
                    <!--<input type="hidden" id="is_active" name="is_active" value="<?php echo e($company->is_active); ?>">-->
                    
                    <div class="mb-3">
                        <div class="text-start mt-2">
                            <input type="hidden" id="db_picture" name="db_picture" value="<?php echo e($company->logo); ?>">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/dpe4njh3p6hj/public_html/alhashemya-group/admin/resources/views/companies/update-company.blade.php ENDPATH**/ ?>