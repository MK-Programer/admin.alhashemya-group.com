    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <div class="mt-0 mb-3">
                        <a href="<?php echo e(route('showCreateUser')); ?>" id="create_user" class="btn btn-primary"><?php echo app('translator')->get('translation.create_new_user'); ?></a>
                    </div>
...
<?php $__env->startSection('script'); ?>
    ...
    <script src="<?php echo e(asset('build/js/users/all-users.js')); ?>"></script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/dpe4njh3p6hj/public_html/alhashemya-group/admin/resources/views/users/all-users.blade.php ENDPATH**/ ?>