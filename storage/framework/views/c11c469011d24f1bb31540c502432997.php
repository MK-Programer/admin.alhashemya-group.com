                    ...
                    <div class="auth-full-page-content p-md-5 p-4">
                        <div class="w-100">
                            <div class="d-flex flex-column h-100">
                                <img src="<?php echo e(URL::asset('build/icons/auth-login.jpg')); ?>" width="100%" height="100%">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('email', 'katty180299.berry@gmail.com')); ?>" id="username" placeholder="Enter Email" autocomplete="email" autofocus>
...
<?php echo $__env->make('layouts.master-without-nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\elhashemya_group\resources\views/auth/login.blade.php ENDPATH**/ ?>