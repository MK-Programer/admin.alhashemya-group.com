    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="mt-0 mb-3">
                        <a href="{{ route('showCreateCompany') }}" id="create_company" class="btn btn-primary">@lang('translation.create_new_company')</a>
                    </div>
...
<script src="{{ asset('build/js/companies/all-companies1.js') }}"></script>
@endsection
