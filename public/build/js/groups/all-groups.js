$(document).ready(function() {
    ...
    $('#groups_table').DataTable({
        ...
        ordering: false,
        ajax: {
            url: "/groups/get-paginated-groups-data",
            type: "GET",
            data: function(d) {
        ...
        columns: [
            ...
            },
            {
                data: null,
                render: function(data, type, row) {
                    return '<button class="btn btn-primary" onclick="redirectToUpdateGroup(\'' + data.encrypted_id + '\')">' + updateText + '</button>';
                },
            },
...
function redirectToUpdateGroup(id) {
    window.location.href = '/groups/update-group/' + id;
}