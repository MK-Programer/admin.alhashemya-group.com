    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <div class="mt-0 mb-3">
                        <a href="{{ route('showCreateUser') }}" id="create_user" class="btn btn-primary">@lang('translation.create_new_user')</a>
                    </div>
...
@section('script')
    ...
    <script src="{{ asset('build/js/users/all-users.js') }}"></script>
@endsection
