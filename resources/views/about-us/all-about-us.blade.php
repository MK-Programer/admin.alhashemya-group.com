    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <div class="mt-0 mb-3">
                        <a href="{{ route('showCreateAboutUs') }}" id="create_about_us" class="btn btn-primary">@lang('translation.create_new_about_us')</a>
                    </div>
...
@section('script')
    ...
    <script src="{{ asset('build/js/about-us/all-about-us.js') }}"></script>
@endsection
