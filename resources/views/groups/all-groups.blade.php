    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <div class="mt-0 mb-3">
                        <a href="{{ route('showCreateGroup') }}" id="create_group" class="btn btn-primary">@lang('translation.create_new_group')</a>
                    </div>
...
@section('script')
    ...
    <script src="{{ asset('build/js/groups/all-groups.js') }}"></script>
@endsection
